...
export const jobs = sqliteTable("jobs", {
  ...
  trimGroupId: text("trim_group_id"),
  trimOriginalUrl: text("trim_original_url"),
  trimPartIndex: integer("trim_part_index"),
  trimPartTotal: integer("trim_part_total"),
  trimStartSec: real("trim_start_sec"),
  trimDurationSec: real("trim_duration_sec"),
